from funcs_excc import func, d_func
import os
import numpy as np
import matplotlib
matplotlib.use('Agg')
...
cwd = os.path.join(os.getcwd(), "testes", "teste-2", "Newton")
img = os.path.join(cwd, "Newton_excc.png")
...
plt.title("Raízes - Método de Newton (Exercício)", fontdict = font)
